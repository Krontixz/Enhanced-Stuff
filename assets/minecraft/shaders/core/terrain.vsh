...
#moj_import <vanilla_tweaks:wavy_core/config.glsl>
#moj_import <vanilla_tweaks:wavy_core/util.glsl>
#moj_import <vanilla_tweaks:wavy_core/main.vsh>
#moj_import <vanilla_tweaks:mob_spawn_indicator/main.vsh>
